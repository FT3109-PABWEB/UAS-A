...
?>
<?php
include ("koneksi.php");require "config/koneksi.php";
...
<body id="top" >
 <div>
  ...
  <tr>
    <td width="32%"><input type="text" name="search" id="search" value="Cari Kode distributor" onfocus="if(!this._haschanged){this.value=''};this._haschanged=true;"/>
    <input type="submit" name="submit" value="CARI"/></td>
    <td width="40%"><a href="?page=page/data/data_distributor" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=page/input/input_distributor">[+Tambah]</a>&nbsp;&nbsp;<a href="page/simpanxls/simpandistributorxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	  ...
	  if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
    ...
    ?>
<tr>
    <td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $data['id_distributor'];?>"/></td>
    ...
    <td width="50" align="center"><a href="?page=page/edit/edit_distributor&id_distributor=<?php echo $data ['id_distributor']; ?>"><img src="img/edit.gif" width="18" height="15" style="border:0px;">UBAH</a></div></td>
    <td width="50" align="center"><a href="?page=page/delete/delete_distributor&id_distributor=<?php echo $data ['id_distributor'];?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA DISTRIBUTOR INI...?')"> <img src="img/delete.gif" width="15" height="15" style="border:0px;">HAPUS</a></td>
  </tr>
  <?php 
  }
}	
