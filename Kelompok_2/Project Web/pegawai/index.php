...
<head>
    ...
    <meta name="author" content="Demmy Ahriyan Rozak, Galih Permana, Muhamad Dwiki Darusalam, Murry Muryadin">
        ...
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    &copy; 2021 - <a class="text-info" href="Kelompok 2 | STMIK Sumedang">Kelompok 2 | STMIK Sumedang</a>
                </div>
            </div>
        </footer>
    </div>
